	...
	public void appendTooltip(ItemStack stack, World world, List<Text> list, TooltipContext flag) {
		if(level == 3){
			if(stack.getNbt() == null){
				...
				stack.getNbt().putInt("Uses", 5);
			}

			list.add(ClientUtils.localize("tooltip.securitycraft:keycard.uses").append(new LiteralText(" " + stack.getNbt().getInt("Uses"))).setStyle(GRAY_STYLE));
