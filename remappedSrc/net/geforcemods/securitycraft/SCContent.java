...
public class SCContent { // TODO: Everything
    ...
    public static final DeferredRegister<Item> ITEMS = new DeferredRegister<>(Registry.ITEM, SecurityCraft.MODID);
    ...
    @HasManualPage @RegisterItemBlock(SCItemGroup.EXPLOSIVES) public static final Block BOUNCING_BETTY = BLOCKS.register("bouncing_betty", () -> new BouncingBettyBlock(prop(Material.DECORATION, 1.0F)));
    ...
    @HasManualPage @RegisterItemBlock(SCItemGroup.EXPLOSIVES) public static final Block CLAYMORE = BLOCKS.register("claymore", () -> new ClaymoreBlock(prop(Material.DECORATION)));
    ...
    @HasManualPage @RegisterItemBlock(SCItemGroup.DECORATION) public static final Block IRON_FENCE = BLOCKS.register("electrified_iron_fence", () -> new IronFenceBlock(prop(Material.METAL, MapColor.IRON_GRAY).sounds(BlockSoundGroup.METAL)));
    ...
    @HasManualPage @RegisterItemBlock public static final Block PORTABLE_RADAR = BLOCKS.register("portable_radar", () -> new PortableRadarBlock(prop(Material.DECORATION)));
    ...
    @HasManualPage @OwnableTE @RegisterItemBlock(SCItemGroup.EXPLOSIVES) public static final Block MINE = BLOCKS.register("mine", () -> new MineBlock(prop(Material.DECORATION, 1.0F)));
    ...
    //items
    @HasManualPage public static final Item ADMIN_TOOL = ITEMS.register("admin_tool", () -> new AdminToolItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1).maxCount(1)));
    public static final Item ANCIENT_DEBRIS_MINE_ITEM = ITEMS.register("acient_debris_mine", () -> new BlockItem(SCContent.ANCIENT_DEBRIS_MINE, itemProp(SecurityCraft.groupSCMine).fireproof()));
    @HasManualPage public static final Item BRIEFCASE = ITEMS.register("briefcase", () -> new BriefcaseItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item CAMERA_MONITOR = ITEMS.register("camera_monitor", () -> new CameraMonitorItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item CODEBREAKER = ITEMS.register("codebreaker", () -> new CodebreakerItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1).maxDamageIfAbsent(3)));
    @HasManualPage public static final Item CRYSTAL_QUARTZ_ITEM = ITEMS.register("crystal_quartz_item", () -> new Item(itemProp(SecurityCraft.groupSCDecoration)));
    @HasManualPage public static final Item FAKE_LAVA_BUCKET = ITEMS.register("bucket_f_lava", () -> new FakeLiquidBucketItem(() -> SCContent.FAKE_LAVA, itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item FAKE_WATER_BUCKET = ITEMS.register("bucket_f_water", () -> new FakeLiquidBucketItem(() -> SCContent.FAKE_WATER, itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item KEYCARD_LVL_1 = ITEMS.register("keycard_lv1", () -> new BaseKeycardItem(itemProp(SecurityCraft.groupSCTechnical), 0));
    @HasManualPage public static final Item KEYCARD_LVL_2 = ITEMS.register("keycard_lv2", () -> new BaseKeycardItem(itemProp(SecurityCraft.groupSCTechnical), 1));
    @HasManualPage public static final Item KEYCARD_LVL_3 = ITEMS.register("keycard_lv3", () -> new BaseKeycardItem(itemProp(SecurityCraft.groupSCTechnical), 2));
    @HasManualPage public static final Item KEYCARD_LVL_4 = ITEMS.register("keycard_lv4", () -> new BaseKeycardItem(itemProp(SecurityCraft.groupSCTechnical), 4));
    @HasManualPage public static final Item KEYCARD_LVL_5 = ITEMS.register("keycard_lv5", () -> new BaseKeycardItem(itemProp(SecurityCraft.groupSCTechnical), 5));
    @HasManualPage public static final Item KEY_PANEL = ITEMS.register("keypad_item", () -> new KeyPanelItem(itemProp(SecurityCraft.groupSCTechnical)));
    public static final Item KEYPAD_CHEST_ITEM = ITEMS.register(KEYPAD_CHEST_PATH, () -> new BlockItem(SCContent.KEYPAD_CHEST, itemProp(SecurityCraft.groupSCTechnical)/*.setISTER(() -> ItemKeypadChestRenderer::new)*/)); //keep this as a method reference or else the server will crash; TODO
    @HasManualPage public static final Item LIMITED_USE_KEYCARD = ITEMS.register("limited_use_keycard", () -> new BaseKeycardItem(itemProp(SecurityCraft.groupSCTechnical), 3));
    @HasManualPage public static final Item REINFORCED_DOOR_ITEM = ITEMS.register("door_indestructible_iron_item", () -> new ReinforcedDoorItem(itemProp(SecurityCraft.groupSCDecoration)));
    @HasManualPage public static final Item REMOTE_ACCESS_MINE = ITEMS.register("remote_access_mine", () -> new MineRemoteAccessToolItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item REMOTE_ACCESS_SENTRY = ITEMS.register("remote_access_sentry", () -> new SentryRemoteAccessToolItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item SCANNER_DOOR_ITEM = ITEMS.register("scanner_door_item", () -> new ScannerDoorItem(itemProp(SecurityCraft.groupSCDecoration)));
    @HasManualPage public static final Item SC_MANUAL = ITEMS.register("sc_manual", () -> new SCManualItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item SECRET_OAK_SIGN_ITEM = ITEMS.register("secret_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_OAK_SIGN, SCContent.SECRET_OAK_WALL_SIGN, "item.securitycraft.secret_sign_item"));
    public static final Item SECRET_SPRUCE_SIGN_ITEM = ITEMS.register("secret_spruce_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_SPRUCE_SIGN, SCContent.SECRET_SPRUCE_WALL_SIGN, "item.securitycraft.secret_spruce_sign_item"));
    public static final Item SECRET_BIRCH_SIGN_ITEM = ITEMS.register("secret_birch_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_BIRCH_SIGN, SCContent.SECRET_BIRCH_WALL_SIGN, "item.securitycraft.secret_birch_sign_item"));
    public static final Item SECRET_JUNGLE_SIGN_ITEM = ITEMS.register("secret_jungle_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_JUNGLE_SIGN, SCContent.SECRET_JUNGLE_WALL_SIGN, "item.securitycraft.secret_jungle_sign_item"));
    public static final Item SECRET_ACACIA_SIGN_ITEM = ITEMS.register("secret_acacia_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_ACACIA_SIGN, SCContent.SECRET_ACACIA_WALL_SIGN, "item.securitycraft.secret_acacia_sign_item"));
    public static final Item SECRET_DARK_OAK_SIGN_ITEM = ITEMS.register("secret_dark_oak_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_DARK_OAK_SIGN, SCContent.SECRET_DARK_OAK_WALL_SIGN, "item.securitycraft.secret_dark_oak_sign_item"));
    public static final Item SECRET_CRIMSON_SIGN_ITEM = ITEMS.register("secret_crimson_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_CRIMSON_SIGN, SCContent.SECRET_CRIMSON_WALL_SIGN, "item.securitycraft.secret_crimson_sign_item"));
    public static final Item SECRET_WARPED_SIGN_ITEM = ITEMS.register("secret_warped_sign_item", () -> new SecretSignItem(itemProp(SecurityCraft.groupSCDecoration).maxCount(16), SCContent.SECRET_WARPED_SIGN, SCContent.SECRET_WARPED_WALL_SIGN, "item.securitycraft.secret_warped_sign_item"));
    @HasManualPage(designedBy="Henzoid") public static final Item SENTRY = ITEMS.register("sentry", () -> new SentryItem(itemProp(SecurityCraft.groupSCTechnical)));
    @HasManualPage public static final Item TASER = ITEMS.register("taser", () -> new TaserItem(itemProp(SecurityCraft.groupSCTechnical).maxDamageIfAbsent(151), false));
    public static final Item TASER_POWERED = ITEMS.register("taser_powered", () -> new TaserItem(itemProp(null).maxDamageIfAbsent(151), true));
    @HasManualPage public static final Item UNIVERSAL_BLOCK_MODIFIER = ITEMS.register("universal_block_modifier", () -> new UniversalBlockModifierItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item UNIVERSAL_BLOCK_REINFORCER_LVL_1 = ITEMS.register("universal_block_reinforcer_lvl1", () -> new UniversalBlockReinforcerItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1).maxDamageIfAbsent(300)));
    @HasManualPage public static final Item UNIVERSAL_BLOCK_REINFORCER_LVL_2 = ITEMS.register("universal_block_reinforcer_lvl2", () -> new UniversalBlockReinforcerItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1).maxDamageIfAbsent(2700)));
    @HasManualPage public static final Item UNIVERSAL_BLOCK_REINFORCER_LVL_3 = ITEMS.register("universal_block_reinforcer_lvl3", () -> new UniversalBlockReinforcerItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item UNIVERSAL_BLOCK_REMOVER = ITEMS.register("universal_block_remover", () -> new UniversalBlockRemoverItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1).maxDamageIfAbsent(476)));
    @HasManualPage public static final Item UNIVERSAL_KEY_CHANGER = ITEMS.register("universal_key_changer", () -> new UniversalKeyChangerItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1)));
    @HasManualPage public static final Item UNIVERSAL_OWNER_CHANGER = ITEMS.register("universal_owner_changer", () -> new UniversalOwnerChangerItem(itemProp(SecurityCraft.groupSCTechnical).maxCount(1).maxDamageIfAbsent(48)));
    @HasManualPage public static final Item WIRE_CUTTERS = ITEMS.register("wire_cutters", () -> new Item(itemProp(SecurityCraft.groupSCTechnical).maxCount(1).maxDamageIfAbsent(476)));
    ...
    private static final AbstractBlock.Settings prop(Material mat, MapColor color) {
