...
public class SecurityCameraTileEntityRenderer extends BlockEntityRenderer<SecurityCameraTileEntity> {
	...
	private static final Quaternion POSITIVE_Y_180 = Vec3f.POSITIVE_Y.getDegreesQuaternion(180.0F);
	private static final Quaternion POSITIVE_Y_90 = Vec3f.POSITIVE_Y.getDegreesQuaternion(90.0F);
	private static final Quaternion NEGATIVE_Y_90 = Vec3f.NEGATIVE_Y.getDegreesQuaternion(90.0F);
	private static final Quaternion POSITIVE_X_180 = Vec3f.POSITIVE_X.getDegreesQuaternion(180.0F);
